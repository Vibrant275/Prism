...
namespace Prism.CodeAnalysis.Emit
{
    internal sealed class Emitter
    {
        ...
        private Emitter(string moduleName, string[] references)
        {
            ...
            TypeReference ResolveType(string? prismName, string metadataName)
            {
                ...
                {
                    _diagnostics.ReportRequiredTypeNotFound(prismName, metadataName);
                }
                else
                {
                    _diagnostics.ReportRequiredTypeAmbiguous(prismName, metadataName, foundTypes);
                }
