...
namespace Prism.CodeAnalysis
{
    internal sealed class DiagnosticBag : IEnumerable<Diagnostic>
    {
        ...
        public void ReportRequiredTypeNotFound(string? prismName, string metadataName)
        {
            var message = prismName == null
                ? $"The required type '{metadataName}' cannot be resolved among the given references."
                : $"The required type '{prismName}' ('{metadataName}') cannot be resolved among the given references.";
            ReportError(default, message);
        }

        public void ReportRequiredTypeAmbiguous(string? prismName, string metadataName, TypeDefinition[] foundTypes)
        {
            ...
            var message = prismName == null
                ...
                : $"The required type '{prismName}' ('{metadataName}') was found in multiple references: {assemblyNameList}.";
            ReportError(default, message);
        }
