...
internal sealed class Binder
{
    ...
    private BoundBinaryOperatorKind? BindBinaryOperatorKind(SyntaxKind kind, Type leftType, Type righType)
    {
        if (leftType == typeof(int) && righType == typeof(int))
        {
            switch (kind)
            {
                case SyntaxKind.PlusToken:
        ...
        if (leftType == typeof(bool) && righType == typeof(bool))
        {
            switch (kind)
            {
